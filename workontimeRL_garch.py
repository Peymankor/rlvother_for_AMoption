...
Test = OptionPricingRL_GARCH(spot_price=80, strike=80, expiry=1, 
                              num_time_steps=50, num_train_paths=5000, rate=0.06)   
...
option_pricing = OptionPricingLSM_GARCH(
...
training_prices = option_pricing.generate_prices(num_paths=num_train_paths_f, 
                                                  initial_price=spot_price_val)

final_day_price_start_time = time.time()
final_day_price = option_pricing.calculate_final_day_price()
final_day_price_end_time = time.time()
final_day_price_execution_time = final_day_price_end_time - final_day_price_start_time

print("EU Price:", final_day_price)
#print("EU Price Execution Time:", final_day_price_execution_time)

lsm_garch_coef_start_time = time.time()
lsm_garch_coef = option_pricing.train_model()
lsm_garch_coef_end_time = time.time()
lsm_garch_coef_execution_time = lsm_garch_coef_end_time - lsm_garch_coef_start_time

#print("LSM GARCH Coefficient:", lsm_garch_coef)
#print("LSM GARCH Coefficient Execution Time:", lsm_garch_coef_execution_time)

garch_lsm_opprice_start_time = time.time()
garch_lsm_opprice, garch_lsm_stop_times = option_pricing.evaluate_model()
garch_lsm_opprice_end_time = time.time()
garch_lsm_opprice_execution_time = garch_lsm_opprice_end_time - garch_lsm_opprice_start_time
