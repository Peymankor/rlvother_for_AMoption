...
if __name__ == "__main__":
    ...
    num_paths_train_val = 10000
    K_value = 40
    k_value = 4
    num_paths_test_val = 2000



    num_scoring_paths_val: int = 2000
    ...
    sd_values_table1 = np.array([0.1, 0.2, 0.4, 0.6, 0.8,2])
    T_values_table1 = np.array([5])
...
chart1_dataset = pd.DataFrame({"vol":vol_list_arr, "S0":S0_list_arr,    
